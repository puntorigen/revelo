(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var presentation = /** @class */ (function () {
        ...
        presentation.prototype.createPresentation = function (target, options) {
            if (options === void 0) { options = { fragments: true }; }
            return __awaiter(this, void 0, void 0, function () {
                var md, yaml, extractjs, mdSource, rendered, cheerio, $, $_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            md.use(require('markdown-it-front-matter'), function (x) { yaml.parse(x); });
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, fs$1.writeFile(target, $_1.html(), 'utf-8', {
                                    encoding: 'utf8',
                                    flag: 'w'
                                })];
                        case 4:
    ...
    var Server = /** @class */ (function (_super) {
        ...
        Server.prototype.process = function () {
            return __awaiter(this, void 0, void 0, function () {
                var spinner, reveal, live, liveServer, express, app, serverLink, open, watch;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.presentation.createPresentation(reveal.presentation, { fragments: true })];
                        case 2:
                            _a.sent();
                            ...
                            app.listen(3000);
                            serverLink = ansiEscapes.link('http://127.0.0.1:3000', 'http://127.0.0.1:3000');
                            spinner.succeed("server listening on #".concat(serverLink, "#"));
                            open = require('open');
                            return [4 /*yield*/, open('http://127.0.0.1:3000')
                            ...
                            watch(path.dirname(sourceFile), {}, function (evt, name) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            _a.trys.push([1, 3, , 4]);
                                            return [4 /*yield*/, this.presentation.createPresentation(reveal.presentation)];
                                        case 2:
                                            _a.sent();
