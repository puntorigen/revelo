    ...
    ***************************************************************************** */
    ...
    var presentation = /** @class */ (function () {
        ...
        presentation.prototype.createPresentation = function (serverUrl, target, options) {
            return __awaiter(this, void 0, void 0, function () {
                var md, yaml, extractjs, mdSource, replies, config, tokens, rendered, cheerio, $, sections, i, item_, x, content_, extract, pattern, ex, $2, encode, chosen, pexels, encryptor, apiKey, pexelClient, videos, mp4, $_1, last_script, codes_, usesMermaid_1, body_, decode_, to_render;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 14:
                            ...
                            return [4 /*yield*/, fs$1.writeFile(target, decode_(to_render), 'utf-8', {
                                    encoding: 'utf8',
                                    flag: 'w'
                                })];
                        case 15:
    ...
    var Server = /** @class */ (function (_super) {
        ...
        Server.prototype.process = function () {
            return __awaiter(this, void 0, void 0, function () {
                var spinner, tunnel, server, liveUrl, random, reveal, warnings, errPres_1, live, liveServer, express, app, serverLink, open, watch;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
