    ...
    ***************************************************************************** */
    ...
    var presentation = /** @class */ (function () {
                        ...
                        case 0:
                            ...
                            asPromise = function () { return new Promise(function (resolve, reject) {
                                ffmpeg(mp4).videoCodec('libvpx')
                                    ...
                                    .size('30%')
                                    .withFps(fps)
                                    .outputOptions('-minrate', '700', '-maxrate', '700', '-threads', '8', '-flags', '+global_header', '-psnr').on('error', function (err, stdout, stderr) {
                                    reject(err);
        ...
        presentation.prototype.createPresentation = function (serverUrl, target, options, spinner) {
            return __awaiter(this, void 0, void 0, function () {
                var md, yaml, extractjs, mdSource, replies, config, tokens, rendered, cheerio, $, sections, videos_, i, item_, x, content_, extract, pattern, ex, $2, encode, chosen, pexels, encryptor, apiKey, pexelClient, videos, mp4, just_file, new_mp4, new_webm, fps_, $_1, last_script, codes_, usesMermaid_1, body_, head_, decode_, to_render;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 7:
                            ...
                            videos_ += 1;
                            if (spinner)
                                spinner.text("downloading & converting background-video ".concat(videos_));
    ...
    var Render = /** @class */ (function (_super) {
        ...
        Render.prototype.recordBrowser = function (url) {
            return __awaiter(this, void 0, void 0, function () {
                var puppeteer, PuppeteerScreenRecorder, minimal_args, browser, page, recorder, treekill;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
