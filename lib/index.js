    ...
    ***************************************************************************** */
    ...
    var helper = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, fs$3.access(file)];
                        case 2:
                            resp = _a.sent();
                            resp = true;
                            return [3 /*break*/, 4];
        ...
        helper.prototype.readFile = function (file, json) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs$3.readFile(file, 'utf-8')];
                        case 1:
                            resp = _a.sent();
                            if (json)
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, fs$3.writeFile(file, data, 'utf-8', {
                                    encoding: 'utf8',
                                    flag: 'w'
                                })];
                        case 1:
    ...
    var presentation = /** @class */ (function () {
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [2 /*return*/, {
                                    ...
                                    presentation: path$2.join(directory, 'reveal.js-master', 'index.html'),
                                    file: down.path
                                }];
                    }
                });
        ...
        presentation.prototype.createPresentation = function (serverUrl, target, options) {
            return __awaiter(this, void 0, void 0, function () {
                var md, yaml, extractjs, mdSource, replies, config, tokens, rendered, cheerio, $, sections, i, item_, x, content_, extract, pattern, ex, $2, encode, chosen, pexels, encryptor, apiKey, pexelClient, videos, mp4, $_1, last_script, codes_, usesMermaid_1, body_, head_, decode_, to_render;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fs$2.readFile(this.sourceFile, { encoding: 'utf-8' })];
                        case 1:
                            mdSource = _a.sent();
                            replies = [];
                            config = {};
                            ...
                            md.use(require('markdown-it-include'), { root: path$2.dirname(this.sourceFile) }); // !!!include(file.md)!!!
                            ...
                            _a.label = 2;
                        case 2:
                            if (!(i < sections.length)) return [3 /*break*/, 12];
                            item_ = $(sections[i]);
                            x = 0;
                            _a.label = 3;
                        case 3:
                            if (!(x < 10)) return [3 /*break*/, 11];
                            content_ = item_.html();
                            ...
                            pattern = extract("-&gt;{command}[{content}]");
                            ex = pattern.extract(content_);
                            if (!ex.command) return [3 /*break*/, 10];
                        ...
                        case 4:
                            ...
                            return [3 /*break*/, 10];
                        case 5:
                            if (!(ex.command == 'background-video')) return [3 /*break*/, 9];
                            if (ex.content.indexOf(',') != -1) { //opacity within value
                                item_.attr('data-background-opacity', ex.content.split(',')[1]);
                                ex.content = ex.content.split(',')[0];
                            }
                            ...
                            if (!(ex.content.indexOf('http') == -1 && ex.content.indexOf('.mp4') == -1 && ex.content.indexOf('.mov') == -1)) return [3 /*break*/, 7];
                        ...
                        case 12:
                            ...
                            if (!(target != '')) return [3 /*break*/, 16];
                            if (!(firstReveal == '')) return [3 /*break*/, 14];
                            return [4 /*yield*/, fs$2.readFile(target, { encoding: 'utf-8' })];
                        case 13:
                            firstReveal = _a.sent();
                            _a.label = 14;
                        case 14:
                            ...
                            return [4 /*yield*/, fs$2.writeFile(target, decode_(to_render), 'utf-8', {
                                    encoding: 'utf8',
                                    flag: 'w'
                                })];
                        case 15:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 10:
                            ...
                            app.use(express['static'](path$1.dirname(sourceFile$1))); //add md file within / public path as well
                            app.listen(3000);
                        ...
                        case 12:
                            ...
                            watch(path$1.dirname(sourceFile$1), {}, function (evt, name) { return __awaiter(_this, void 0, void 0, function () {
                                var err_1;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            if (this.arg.public) ;
                                            //clean tmpdir
                                            return [4 /*yield*/, fs$1.rm(tmpdir, { recursive: true })];
                                        case 1:
                                            //clean tmpdir
                                            _a.sent();
