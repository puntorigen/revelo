    ...
    ***************************************************************************** */
    ...
    var presentation = /** @class */ (function (_super) {
        ...
        function presentation(sourcefile) {
            ...
            _this.x_console = new (require('@concepto/console'))();
                            ...
                            asPromise = function () { return new Promise(function (resolve, reject) {
                                dl(url, {
                                    ...
                                    onProgress: function (x) {
                                        _this.emit('downloadFileProgress', x);
                                    },
        ...
        presentation.prototype.convertToWebm = function (mp4, output) {
            return __awaiter(this, void 0, void 0, function () {
                var ffmpeg, asPromise, down;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            asPromise = function () { return new Promise(function (resolve, reject) {
                                ffmpeg(mp4).videoCodec('libvpx')
                                    ...
                                    .size('50%')
                                    .outputOptions('-minrate', '1000', '-maxrate', '1000', '-threads', '8', '-flags', '+global_header', '-psnr').on('error', function (err, stdout, stderr) {
                                    reject(err);
        ...
        presentation.prototype.createPresentation = function (serverUrl, target, options) {
            return __awaiter(this, void 0, void 0, function () {
                var md, yaml, extractjs, mdSource, replies, config, tokens, rendered, cheerio, $, sections, i, item_, x, content_, extract, pattern, ex, $2, encode, chosen, pexels, encryptor, apiKey, pexelClient, videos, mp4, just_file, new_mp4, new_webm, $_1, last_script, codes_, usesMermaid_1, body_, head_, decode_, to_render;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            _a.label = 2;
                        case 2:
                            if (!(i < sections.length)) return [3 /*break*/, 16];
                            item_ = $(sections[i]);
                            x = 0;
                            _a.label = 3;
                        case 3:
                        ...
                        case 7:
                            ...
                            return [4 /*yield*/, this.convertToWebm(mp4, new_webm)];
                        case 8:
                            _a.sent();
                            mp4 = '/' + just_file + '.webm';
                            _a.label = 9;
                        ...
                        case 16:
                            ...
                            if (!(target != '')) return [3 /*break*/, 20];
                            if (!(firstReveal == '')) return [3 /*break*/, 18];
    ...
    var Render = /** @class */ (function (_super) {
        ...
        Render.prototype.createReveal = function () {
            return __awaiter(this, void 0, void 0, function () {
                var reveal, options_, warnings, errPres_1;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 3:
                            warnings = _a.sent();
                            this.presentation.on('convertToWebm:start', function (data) {
                                _this.spinner.text("downloading video ".concat(data));
                            });
                            this.presentation.on('convertToWebm:progress', function (progress) {
                                _this.spinner.text("converting video ".concat(progress.percent, "%"));
                            });
                            /*
        ...
        Render.prototype.recordBrowser = function (url) {
            return __awaiter(this, void 0, void 0, function () {
                var puppeteer, PuppeteerScreenRecorder, minimal_args, browser, page, recorder;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        Render.prototype.process = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(this.targetFormat == 'mp4')) return [3 /*break*/, 4];
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.recordBrowser('http://127.0.0.1:3000')];
                        case 2:
                            _a.sent();
