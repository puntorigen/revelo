    ...
    ***************************************************************************** */
    ...
    var Server = /** @class */ (function (_super) {
        ...
        Server.prototype.createPresentation = function (target) {
            return __awaiter(this, void 0, void 0, function () {
                var mdSource, parsed, tmp;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs.readFile(sourceFile, { encoding: 'utf-8' })];
                        case 1:
                            mdSource = _a.sent();
                            parsed = marked.lexer(mdSource);
                            slides = { slides: [], config: {} };
                            tmp = { configSlide: false, tmpdir: tmpdir, config: [], acumulate: [] };
                            parsed.forEach(function (item, idx) { return __awaiter(_this, void 0, void 0, function () {
                                var yaml_1;
                                return __generator(this, function (_a) {
                                    if (item.type == 'hr' && idx == 0) {
                                        ...
                                        if (item.type == 'hr') {
                                            ...
                                            yaml_1 = require('yaml');
                                            tmp.config.forEach(function (row) {
                                                try {
                                                    slides.config = _assign(_assign({}, slides.config), yaml_1.parse(row.raw));
                                                }
                                                catch (configErr) {
                                        ...
                                        if (item.type != 'hr' && item.type != 'heading') {
                                            ...
                                            if (item.text.indexOf("people's network") != -1)
                                                console.log('DUMMY how are dump', { item: item, idx: idx, tmp: tmp });
